...
<div class="container">
    <ul class="nav nav-tabs">
        <li class="active"><a href="#">待申请</a></li>
        <li><a href="#">已申请</a></li>
        <li><a href="#">已驳回</a></li>
    </ul>
    <form class="form-horizontal panel-heading" role="form" method="get" enctype="multipart/form-data" style="background:lightgray">
